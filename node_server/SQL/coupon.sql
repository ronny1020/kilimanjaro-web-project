...
CREATE TABLE coffee.coupon (
  ...
  CONSTRAINT pair UNIQUE (productID)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ;

CREATE INDEX productID ON coffee.coupon (productID);

INSERT INTO coffee.coupon (couponName,productID,minus,cpendDate) VALUES ('20元折抵',0000164413,20,'2020-06-30'),('20元折抵',0000164415,20,'2020-06-30'),('20元折抵',0000164513,20,'2020-06-30');